...
public class ControllerCouleurDifficile {
	...
	@FXML
	private Circle l105 = new Circle();
	@FXML
	...
	private void handleResultat() throws Exception {
		...
		if(Cercle1.getFill()==Cercleminus.getFill() || Cercle2.getFill()==Cercleminus.getFill() || Cercle3.getFill()==Cercleminus.getFill() || Cercle4.getFill()==Cercleminus.getFill() || Cercle5.getFill()==Cercleminus.getFill()) {
			...
			if(w==5) {
				Resultat.setText("Bravo avez gagné !!");
			}
			if (l11.getFill()==Cercleminus.getFill() || l12.getFill()==Cercleminus.getFill() || l13.getFill()==Cercleminus.getFill() || l14.getFill()==Cercleminus.getFill() || l15.getFill()==Cercleminus.getFill()) {
				l11.setFill(Cercle1.getFill());
				l12.setFill(Cercle2.getFill());
				l13.setFill(Cercle3.getFill());
				l14.setFill(Cercle4.getFill());
				l15.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if (l21.getFill()==Cercleminus.getFill() || l22.getFill()==Cercleminus.getFill() || l23.getFill()==Cercleminus.getFill() || l24.getFill()==Cercleminus.getFill() || l25.getFill()==Cercleminus.getFill()) {
				l21.setFill(Cercle1.getFill());
				l22.setFill(Cercle2.getFill());
				l23.setFill(Cercle3.getFill());
				l24.setFill(Cercle4.getFill());
				l25.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if(l31.getFill()==Cercleminus.getFill() || l32.getFill()==Cercleminus.getFill() || l33.getFill()==Cercleminus.getFill() || l34.getFill()==Cercleminus.getFill() || l35.getFill()==Cercleminus.getFill()) {
				l31.setFill(Cercle1.getFill());
				l32.setFill(Cercle2.getFill());
				l33.setFill(Cercle3.getFill());
				l34.setFill(Cercle4.getFill());
				l35.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if(l41.getFill()==Cercleminus.getFill() || l42.getFill()==Cercleminus.getFill() || l43.getFill()==Cercleminus.getFill()|| l44.getFill()==Cercleminus.getFill() || l45.getFill()==Cercleminus.getFill()) {
				l41.setFill(Cercle1.getFill());
				l42.setFill(Cercle2.getFill());
				l43.setFill(Cercle3.getFill());
				l44.setFill(Cercle4.getFill());
				l45.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if (l51.getFill()==Cercleminus.getFill() || l52.getFill()==Cercleminus.getFill() || l53.getFill()==Cercleminus.getFill() || l54.getFill()==Cercleminus.getFill() || l55.getFill()==Cercleminus.getFill()) {
				l51.setFill(Cercle1.getFill());
				l52.setFill(Cercle2.getFill());
				l53.setFill(Cercle3.getFill());
				l54.setFill(Cercle4.getFill());
				l55.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if (l61.getFill()==Cercleminus.getFill() || l62.getFill()==Cercleminus.getFill() || l63.getFill()==Cercleminus.getFill() || l64.getFill()==Cercleminus.getFill() || l65.getFill()==Cercleminus.getFill()) {
				l61.setFill(Cercle1.getFill());
				l62.setFill(Cercle2.getFill());
				l63.setFill(Cercle3.getFill());
				l64.setFill(Cercle4.getFill());
				l65.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if (l71.getFill()==Cercleminus.getFill() || l72.getFill()==Cercleminus.getFill() || l73.getFill()==Cercleminus.getFill() || l74.getFill()==Cercleminus.getFill() || l75.getFill()==Cercleminus.getFill()) {
				l71.setFill(Cercle1.getFill());
				l72.setFill(Cercle2.getFill());
				l73.setFill(Cercle3.getFill());
				l74.setFill(Cercle4.getFill());
				l75.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if (l81.getFill()==Cercleminus.getFill() || l82.getFill()==Cercleminus.getFill() || l83.getFill()==Cercleminus.getFill() || l84.getFill()==Cercleminus.getFill() || l85.getFill()==Cercleminus.getFill()) {
				l81.setFill(Cercle1.getFill());
				l82.setFill(Cercle2.getFill());
				l83.setFill(Cercle3.getFill());
				l84.setFill(Cercle4.getFill());
				l85.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if (l91.getFill()==Cercleminus.getFill() || l92.getFill()==Cercleminus.getFill() || l93.getFill()==Cercleminus.getFill() || l94.getFill()==Cercleminus.getFill() || l95.getFill()==Cercleminus.getFill()) {
				l91.setFill(Cercle1.getFill());
				l92.setFill(Cercle2.getFill());
				l93.setFill(Cercle3.getFill());
				l94.setFill(Cercle4.getFill());
				l95.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
			...
			if( l101.getFill()==Cercleminus.getFill() || l102.getFill()==Cercleminus.getFill() || l103.getFill()==Cercleminus.getFill() || l104.getFill()==Cercleminus.getFill() || l105.getFill()==Cercleminus.getFill()) {
				l101.setFill(Cercle1.getFill());
				l102.setFill(Cercle2.getFill());
				l103.setFill(Cercle3.getFill());
				l104.setFill(Cercle4.getFill());
				l105.setFill(Cercle5.getFill());
				Cercle1.setFill(Color.WHITE);
				Cercle2.setFill(Color.WHITE);
				Cercle3.setFill(Color.WHITE);
				Cercle4.setFill(Color.WHITE);
	...
	//methode pour remplir le dernier cercle de la combinaison
	@FXML
	private void handleButtonJaune5() throws Exception {
		tabluser[4]=1;
		Cercle5.setFill(Color.YELLOW);


	}
	@FXML
	private void handleButtonBleu5() throws Exception {
		tabluser[4]=2;
		Cercle5.setFill(Color.BLUE);	


	}
	@FXML
	private void handleButtonRouge5() throws Exception {
		tabluser[4]=3;
		Cercle5.setFill(Color.RED);


	}
	@FXML
	private void handleButtonVert5() throws Exception {
		tabluser[4]=4;
		Cercle5.setFill(Color.GREEN);


	}
	@FXML
	private void handleButtonOrange5() throws Exception {
		tabluser[4]=5;
		Cercle5.setFill(Color.ORANGE);


	}
	@FXML
	private void handleButtonNoir5() throws Exception {
		tabluser[4]=6;
		Cercle5.setFill(Color.BLACK);	
